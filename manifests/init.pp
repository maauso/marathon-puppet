...
#
# [*event_subscriber*]
#   Activate callback with http_callback optiona
# [*mesos_role*]
#   This should be a unique role and will be used implicitly that is,only if you want use Persistent Volumes, you don't need to configure the Mesos master via
class marathon(
  $repo_manage            = true,
  ...
  $artifact_store         = undef,
  $event_subscriber       = undef,
  $service_manage         = true,
